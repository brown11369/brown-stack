        ...
        <div className="bg-black p-10 text-base leading-8">
            <div className="flex">
                <div className="sm:basis-1/2">
                    ...
                    <h2 className="text-2xl">Hello&sbquo; I&apos;m</h2>
                    <h2 className="text-[#1fb7fc] text-2xl">{userData?.user}</h2>
                    <p className="py-4">{userData?.home}</p>
                </div>
            ...
            <div className="flex flex-wrap gap-2">
                ...
                <a href={`mailto:${userData?.email}`} className="flex items-center gap-x-1  border-2 border-[#1fb7fc] text-[#1fb7fc] px-4 rounded-full"><FaIcons.FaEnvelope className="fill-[#1fb7fc]" />{userData?.email}</a>
            </div>
        </div>
    )
}
